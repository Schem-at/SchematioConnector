...
class HttpUtil(private val apiKey: String, private val apiEndpoint: String, private val logger: Logger) : Closeable {
    ...
    /**
     * Check if a URL is from an allowed domain for image fetching.
     * This is kept in core for URL validation, but actual image fetching
     * with map conversion should use platform-specific implementations.
     */
     ...
     * Returns the raw image bytes without any platform-specific conversion.
