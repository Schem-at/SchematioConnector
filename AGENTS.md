...
Apply [.agents/skills/no-ai-slop/SKILL.md](.agents/skills/no-ai-slop/SKILL.md)
and its `eval.md` when editing the README, release notes, installation instructions,
or Schematio articles about this project. The audience is Minecraft players and
server owners. Draft from the code and verified behavior, then run the editing
