# SchematioConnector 1.4.1

This packaging patch includes the font license notices bundled by panel-lib 0.1.4.
Its compiled game classes match the tested 1.4.0 release.

Axiom 6.0.5 has a Schematio library tool on every supported Fabric target:
...
This release bundles panel-lib 0.1.4. Its toolbar starts with your mods; layout
...
[GitHub Releases](https://github.com/Schem-at/SchematioConnector/releases/tag/v1.4.1).
...
For Paper, install `SchematioConnector-Paper-1.4.1.jar` in `plugins/`. Install
...
All six targets were rebuilt and unit-tested for 1.4.1, and all seven release jars
passed packaging checks. Every compiled class matches 1.4.0, as do the compiled
classes in the bundled panel-lib update. The runtime evidence below was collected
on 1.4.0 before this packaging-only patch.
...
- Detailed Axiom placement, cancellation and repeated editor handoffs on 26.2
  are recorded in [the integration evidence](https://github.com/Schem-at/SchematioConnector/blob/v1.4.1/docs/editor-integration.md).
